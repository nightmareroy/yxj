 ...
 */
@Component("channel:1001")
public class QengAndroidHandler extends AbstractChannelHander {
	// 清源分配的应用ID
	@Value("${android.qeng.app.id}")
	private String APP_ID;
	// 清源分配的登录地址
	@Value("${android.qeng.check.url}")
	private String CHECK_URL;
	// 清源分配的私钥
	@Value("${android.qeng.privatekey}")
