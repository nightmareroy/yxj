...
public final class Out {
	...
	private static void writer(LocalDateTime date, String x) throws IOException {
		...
		if (fileWriter == null || date.getHour() != lastWriterHour) {
			...
			filename.append(GConfig.getInstance().getServerID()).append(File.separator);
			filename.append("login-").append(date.format(FILE_FORMATTER)).append(".log");
