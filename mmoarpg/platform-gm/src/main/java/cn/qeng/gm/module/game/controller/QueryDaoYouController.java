 ...
 */
@Controller
@RequestMapping("/game/query/daoyou")
public class QueryDaoYouController {
	@Autowired
	...
	@Auth(AuthResource.QUERY_DAOYOU)
	@RecordLog(OperationType.QUERY_DAOYOU_MANAGE)
	public ModelAndView manage() {
		ModelAndView view = new ModelAndView("/game/query/daoyou/list");
