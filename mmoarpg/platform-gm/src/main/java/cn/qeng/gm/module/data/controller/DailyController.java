...
import cn.qeng.gm.module.data.service.DailyService;
...
public class DailyController {
	...
	@RecordLog(OperationType.DATA_DAILY)
	...
	public ModelAndView list(@RequestParam(required = false) String reservationtime, @RequestParam(required = false, name = "serverIds") String serverIds) {
		ModelAndView view = new ModelAndView("data/daily/list");
		...
		view.addObject("data", dailyService.getDailyStatistics(start, end, sidList));
		return view;
	}
}
