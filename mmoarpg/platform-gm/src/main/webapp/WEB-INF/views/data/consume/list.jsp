...
<section class="content">
	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<form role="form" action="${pageContext.request.contextPath}/data/consume/list/" method="post" id="queryData">
	...
	<c:if test="${not empty data}">
		...
		<div class="box">
			<div class="box-header with-border">
				<div class="box-header with-border">
					<h3 class="box-title">货币消耗分布数据</h3>
				</div>
				<div class="box-body">
...
<script>
	$('#queryData').on('submit', function() {
		...
		ajaxLoadPage2Body($(this).attr("action")+"?serverIds="+serverIds.join(',')+"&reservationtime="+$("#reservationtime").val()+"&itemcode="+$("#itemcode").val());
		return false;
	});
