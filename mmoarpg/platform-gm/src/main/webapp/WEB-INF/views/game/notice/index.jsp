...
<section class="content-header">
	<h1>${notice==null? '添加游戏内公告':'编辑游戏内公告'}</h1>
	<ol class="breadcrumb">
		<li><a href="${pageContext.request.contextPath}/welcome/"><i class="fa fa-dashboard"></i> 首页</a></li>
		<li><a href="${pageContext.request.contextPath}/game/notice/list/">游戏内公告</a></li>
		<li class="active">${notice==null? '添加游戏内公告':'编辑游戏内公告'}</li>
	</ol>
</section>
		...
		<div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">游戏内公告信息</h3>
				</div>
				
				<form role="form" action="${pageContext.request.contextPath}/game/notice/${notice==null? 'add':'edit'}/" method="post" id="editNotice">
					<div class="box-body">
...
$(function() {
	...
	$('#editNotice').on('submit', function() {
		...
		$.post($(this).attr("action"), {
			...
			$btn.button('reset');
			resultCallback("操作成功", "javascript:ajaxLoadPage2Body('${pageContext.request.contextPath}/game/notice/list/');");
		});
